...
<body>
<header class="topbar">
    <a href="https://wildcodeschool.fr/" target="_blank"><img src="img/wcs_logo_pink_background_400x220.png"
                                                              alt="logo_wcs"></a>
    <nav>
...
<div class="main-page">
    ...
    <h1><?php echo $wilder[0]; ?></h1>


    <div class="bloc-image-detail"><img src="https://i.postimg.cc/qR22tMHn/geoffrey.jpg" alt="Geoffrey"></div>
    <h2>BIOGRAPHIE</h2>
    <p class="detail-paragraphe">Nordiste pure souche, Geoffrey est originaire de Boulogne-sur-mer dans le Pas de
        Calais.
    ...
    <div class="bloc-reseau-social">
        <a href="mailto:b3b3rseg@gmail.com"><img class="logo-reseau-social-courriel"
                                                 src="https://i.postimg.cc/zvjCsbP7/email.png" alt="email"></a>
        <a href="https://github.com/jef933" target="_blank"><img class="logo-reseau-social"
